...
resourcename="esqueletos"  # lower case, only
resourcegroup="esqueletos_rg"
...
# git clone https://github.com/apilogicserver/esqueletos.git
# cd esqueletos
...
az group create --name esqueletos_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group esqueletos_rg --sku S1 --is-linux
az container create --resource-group esqueletos_rg --name esqueletos --image apilogicserver/esqueletos:latest --dns-name-label esqueletos --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//esqueletos.westus.azurecontainer.io:5656'
