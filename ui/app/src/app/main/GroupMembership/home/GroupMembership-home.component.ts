...
@Component({
  selector: 'GroupMembership-home',
  templateUrl: './GroupMembership-home.component.html',
  styleUrls: ['./GroupMembership-home.component.scss']
})
export class GroupMembershipHomeComponent implements AfterViewInit {
