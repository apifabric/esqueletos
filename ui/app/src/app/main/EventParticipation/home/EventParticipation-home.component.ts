...
@Component({
  selector: 'EventParticipation-home',
  templateUrl: './EventParticipation-home.component.html',
  styleUrls: ['./EventParticipation-home.component.scss']
})
export class EventParticipationHomeComponent implements AfterViewInit {
