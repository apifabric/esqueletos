...
@Component({
  selector: 'Reaction-home',
  templateUrl: './Reaction-home.component.html',
  styleUrls: ['./Reaction-home.component.scss']
})
export class ReactionHomeComponent implements AfterViewInit {
